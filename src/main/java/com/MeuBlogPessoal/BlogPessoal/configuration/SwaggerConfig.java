package com.MeuBlogPessoal.BlogPessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.MeuBlogPessoal.BlogPessoal.controller"))
	...
	private static Contact contact() {
		return new Contact("Dayanne Chaves", "https://github.com/dayannemdc", "dayannemdchaves@gmail.com");
	}
